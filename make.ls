...
g++ -c src/render/render.cpp -o obj/render.o -llua5.2 -lSDL -lGL -lSOIL
g++ -c src/scene/scene.cpp -o obj/scene.o    -llua5.2 -I/usr/include/lua5.2
g++ -c src/wavefront/wavefront.cpp -o obj/wavefront.o  -llua5.2 -lSDL -lSOIL -std=c++11 -I/usr/include/lua5.2
...
g++ obj/main.o obj/object.o obj/render.o obj/scene.o obj/wavefront.o obj/keyboard.o obj/material.o  obj/locate.o obj/camera.o -o redMoon -Wall -lglut -lGLU -ldl -llua5.2 -lSDL -lGL -lSOIL -I/usr/include/lua5.2 -pthread -Wall
