...
g++ -c src/placeable/placeable.cpp -o obj/placeable.o  -llua5.2 -I/usr/include/lua5.2
...
g++ -c src/text/text.cpp -o obj/text.o -lGL -lglut 

g++ obj/main.o obj/object.o obj/render.o obj/scene.o obj/wavefront.o obj/keyboard.o obj/material.o  obj/placeable.o obj/camera.o obj/lightLamp.o obj/text.o -o  redMoon -Wall -lglut -lGLU -ldl -llua5.2 -lSDL -lGL -lSOIL -lGLEW -I/usr/include/lua5.2 -pthread -Wall
